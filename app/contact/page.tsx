...
export const metadata: Metadata = {
  ...
  description:
    "Une question avant de vous inscrire ? Écrivez-nous ou appelez du mardi au samedi, de 9h à 18h.",
};
    ...
    <main>
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "60px 40px 12px" }}>
        ...
        <p style={{ fontSize: 21, lineHeight: 1.65, color: "#5E434A", margin: 0, maxWidth: "40em" }}>
          Appelez-nous du mardi au samedi, de 9h à 18h, ou laissez-nous un
          message : nous répondons toujours à quelqu&apos;un de vive voix,
          jamais par répondeur.
        </p>
      </section>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <a href="mailto:bonjour@creaqueen.fr" style={{ fontSize: 19, color: "#4A3138" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 18, lineHeight: 1.6, color: "#4A3138", margin: 0 }}>
              14 rue des Capucins
              <br />
              69001 Lyon
            </p>
